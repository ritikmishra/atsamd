...
#[hal_module(
    any("sercom0-d1x", "sercom0-d21") => "spi/pads_thumbv6m.rs",
...
#[hal_module(
    any("sercom0-d1x", "sercom0-d21") => "spi/char_size.rs",
    "sercom0-d5x" => "spi/length.rs",
)]
pub mod size {}

#[cfg(doc)]
#[hal_cfg(not(any("sercom0-d1x", "sercom0-d21")))]
